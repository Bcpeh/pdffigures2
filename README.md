...
1. Set PYTHONPATH to the root directory of the project:
   ...
   export PYTHONPATH=/`pwd`
   ```
2. Note that if you would like to have section with respective results, you need to set the `run_section_extraction` to `True`, this might take a while and also requires OPENAI_API_KEY to be set.
